  ...
  return (
    <div className="flex flex-row justify-between w-full h-20 bg-slate-100">
      ...
      <div className="flex flex-row gap-2 pr-4">
        ...
        <div className="w-16 h-16 p-1 cursor-pointer hover:brightness-110" onClick={handleClickOpen("paper")}>
          ...
          <Box sx={{ flexGrow: 1 }}>
              <div className="font-sans text-lg min-w-52">
                <div className="flex flex-col w-full text-left">
                  ...
                  />
                  <Box sx={{ width: '100%', bgcolor: 'background.paper', height:'620px', overflow:'auto' }}>
                  {
                    MusicCategoryList?.map((item, index) => {
                      return (
                        <List component="nav" aria-label="main mailbox folders" key={index} disablePadding>
                          <ListItemButton
